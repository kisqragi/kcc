...
int main() {
    ...
    assert(6, ({ int a; int b; a=3; b=3; b+a; }), "({ int a; int b; a=3; b=3; b+a; })");

    assert(3, ({ int _a=3; _a; }), "({ int _a=3; _a; })");
    ...
    assert(1, ({ int x[1][1][1]; ***x = 1; ***x; }), "({ int x[1][1][1];  ***x = 1; ***x; })");
    ...
    assert(4, ({ int x[2][3]; int *y=x; y[4]=4; x[1][1]; }), "({ int x[2][3]; int *y=x; y[4]=4; x[1][1]; })");
    assert(5, ({ int x[2][3]; int *y=x; y[5]=5; x[1][2]; }), "({ int x[2][3]; int *y=x; y[5]=5; x[1][2]; })");
    assert(4, ({ int x[3]; x[1]=4; x[2]=5; x[1]; }), "({ int x[3]; x[1]=4; x[2]=5; x[1]; })");
    assert(5, ({ int x[3]; x[1]=4; x[2]=5; x[2]; }), "({ int x[3]; x[1]=4; x[2]=5; x[2]; })");
    ...
    assert(2, ({ int i = 0; int a[2]; a[1] = 2; a[++i]; }), "({ int i = 0; int a[2]; a[1] = 2; a[++i]; })");
    assert(3, ({ int i = 0; int a[2]; a[0] = 3; a[1] = 2; a[i++]; }), "({ int i = 0; int a[2]; a[0] = 3 ;a[1] = 2; a[i++]; })");
...
//    assert(1, ({ int i = 0; int x[1] = {1,2,3}; x[0]; }), "({ int i = 0; int x[1] = {1,2,3}; x[0]; })");
    ...
    assert(1, ({ char a; sizeof a << 63 >> 63; }), "({ char a; sizeof a << 63 >> 63; })");
