...
assert 3 'int main() { if (2-1) if (1-1) return 2; return 3; }'
...
assert 1 'int main() { int x[1][1][1]; ***x = 1; return ***x; }'
...
assert 4 'int main() { int x[2][3]; int *y=x; y[4]=4; return x[1][1]; }'
assert 5 'int main() { int x[2][3]; int *y=x; y[5]=5; return x[1][2]; }'
assert 4 'int main() { int x[3]; x[1]=4; x[2]=5; return x[1]; }'
assert 5 'int main() { int x[3]; x[1]=4; x[2]=5; return x[2]; }'
...
assert 255 'int main() { return "\377"[0]; }'
